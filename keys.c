...
/*   Updated: 2022/05/30 14:26:10 by ahaifoul         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int key_press(int keycode,t_map *map)
{
	...
	else if ((keycode == W_KEY  || keycode == A_KEY) && ft_pos(map->buf[(int)(map->player_y + y)][(int)(map->player_x + x)]))//up
		move_BackForth(keycode, map, x, y);
	else if ((keycode == D_KEY || keycode == S_KEY) && ft_pos(map->buf[(int)(map->player_y - y)][(int)(map->player_x - x)]))//up
